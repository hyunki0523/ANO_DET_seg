...
def predict_entry_point_modelfolder():
    ...
    parser.add_argument('-npp', type=int, required=False, default=10,
                        help='Number of processes used for preprocessing. More is not always better. Beware of '
                             'out-of-RAM issues. Default: 10')
    parser.add_argument('-nps', type=int, required=False, default=10,
...
if __name__ == '__main__':
    ...
    predictor.initialize_from_trained_model_folder(
        join(nnUNet_results, 'Dataset500_dental/nnUNetTrainer__nnUNetPlans__3d_fullres'),
        use_folds=(0, ),
        checkpoint_name='checkpoint_final.pth',
    )
    predictor.predict_from_files( '/mnt/nas100/forGPU2/SungchulOn/test/nii',
                                 join(nnUNet_raw, 'Dataset500_dental/imagesTs_predlowres'),
    ...
    img, props = SimpleITKIO().read_images([join(nnUNet_raw, 'Dataset500_dental/imagesTr/liver_63_0000.nii.gz')])
